...
1. **Viewpoint Experiment** - Object recognition across viewpoint transformations (54 infants, 20 adults)
2. **Occlusion Experiment** - Representation invariance under partial occlusion (19 infants, 20 adults)
3. **Congruence Experiment** - Cross-modal congruence effects (in progress)
...
│
├── congruence/            # Cross-modal congruence experiment
│   └── [same structure as viewpoint]
│
