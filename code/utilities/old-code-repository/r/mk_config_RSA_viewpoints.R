...
main_dir <- file.path(HOME, "Documents", "PhD", "Project")
project_name <- "viewpoint"
project_root = file.path(main_dir, project_name)
...
output_file <- file.path(main_dir, "shared/config/viewpoint_RSA_config.json")
